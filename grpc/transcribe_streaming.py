...
def listen_print_loop(recognize_stream):
    ...
    for resp in recognize_stream:
        ...
        if not result.is_final:
            ...
            # If this is the first transcription for this utterance, start the timer
            ...
            # Show recognized transcript on console
            print(transcript + '\n')

            # Give a qualitative clarity judgment based on confidence rating
            confidence_rating = result.alternatives[0].confidence * 100
            if (confidence_rating > 80):
                clarity_indication = 'CLEAR'
            elif (confidence_rating > 50):
                clarity_indication = 'SOMEWHAT MUFFLED'
            else:
            ...
            # Give a qualitative pace judgment based on calculated words per minute spoken
            time_taken = end_time - start_time
            words_per_minute = int(math.ceil(num_words / time_taken * 60))
            if (words_per_minute > 180):
                talking_speed_indication = 'TOO FAST, breathe.'
            elif (words_per_minute > 160):
                talking_speed_indication = "YOU'RE FAST."
            elif (words_per_minute > 120):
                talking_speed_indication = 'YOUR PACE IS GOOD. Keep it up.'
            elif (words_per_minute > 100):
                talking_speed_indication = 'A LITTLE SLOW.'
            else:
